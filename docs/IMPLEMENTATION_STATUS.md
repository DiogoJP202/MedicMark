...
| `dotnet test ChecklistPlantao.NoMaui.slnf -c Release` | ✅ **541 testes, 0 falhas** |
...
| UI.Tests (bUnit) | 250 | Componentes, filtros, faixas, desvio da primeira execução, estado da conexão no login, contenção de falha de tela, modais de cadastro e hierarquia da administração, **contraste medido da folha de estilo nos dois temas** |
...
| 30 | Testes compatíveis passam | ✅ **541 testes** |
