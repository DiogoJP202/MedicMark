...
| `dotnet test ChecklistPlantao.NoMaui.slnf -c Release` | ✅ **390 testes, 0 falhas** |
...
| UI.Tests (bUnit) | 99 | Componentes, filtros, faixas, desvio da primeira execução, estado da conexão no login, contenção de falha de tela, **modais de cadastro e hierarquia da administração** |
...
| 30 | Testes compatíveis passam | ✅ **390 testes** |
