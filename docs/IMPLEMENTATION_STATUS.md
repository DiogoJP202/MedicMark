...
| `dotnet test ChecklistPlantao.NoMaui.slnf -c Release` | ✅ **365 testes, 0 falhas** |
...
| Client.Core.Tests | 68 | Persistência offline, fila, idempotência, conflito, auth offline, recusa do servidor, grafo de dependências real, sessão entre escopos e **versão do esquema local** |
...
| 30 | Testes compatíveis passam | ✅ **365 testes** |
